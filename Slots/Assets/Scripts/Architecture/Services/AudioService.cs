...
namespace Architecture.Services
{
    public class AudioService : IAudioService
    {
        ...
        private AudioSource _slotSpinAudioSource;
        ...
        public void PlaySlotSpinSound(float baseSpeed, float currentSpeed)
        {
            float baseAudioSpeed = 1.0f;
            float speedMultiplier = baseSpeed / currentSpeed;
            float adjustedAudioSpeed = baseAudioSpeed * speedMultiplier;
            
            SfxData sfxData = GetSfxData(SfxType.SlotSpin);
            _slotSpinAudioSource.pitch = adjustedAudioSpeed;
            _slotSpinAudioSource.PlayOneShot(sfxData.Clip);
        }
        ...
        private void InitializeSlotSpinAudioSource()
        {
            _slotSpinAudioSource = _baseFactory.CreateBaseWithContainer<AudioSource>(AssetPath.SlotSpinAudioSource);
        }
    }
}