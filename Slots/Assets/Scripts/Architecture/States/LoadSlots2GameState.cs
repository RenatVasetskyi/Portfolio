...
{
    public class LoadSlots2GameState : IState
    {
        ...
        public LoadSlots2GameState(ISceneLoader sceneLoader, IGamePauser gamePauser,
        ...
        private void Initialize()
        {
            ...
            Canvas gameView = _baseFactory.CreateBaseWithContainer<Canvas>(AssetPath.Slots2GameView, parent);
            gameView.worldCamera = camera;

            _audioService.PlayMusic(MusicType.Slots2);
        }
    }
}