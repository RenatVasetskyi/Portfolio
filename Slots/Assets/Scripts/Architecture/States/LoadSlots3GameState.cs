...
{
    public class LoadSlots3GameState : IState
    {
        ...
        public LoadSlots3GameState(ISceneLoader sceneLoader, IGamePauser gamePauser,
        ...
        private void Initialize()
        {
            ...
            Canvas gameView = _baseFactory.CreateBaseWithContainer<Canvas>(AssetPath.Slots3GameView, parent);
            gameView.worldCamera = camera;

            _audioService.PlayMusic(MusicType.Slots3);
        }
    }
}